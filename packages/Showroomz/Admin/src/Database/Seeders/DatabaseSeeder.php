...
namespace Showroomz\Admin\Database\Seeders;
...
use Showroomz\Core\Database\Seeders\DatabaseSeeder as CoreSeeder;
use Showroomz\User\Database\Seeders\DatabaseSeeder as UserSeeder;
