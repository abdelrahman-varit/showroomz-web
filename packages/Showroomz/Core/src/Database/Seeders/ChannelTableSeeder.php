    ...
    public function run()
    {
        ...
        DB::table('channels')->insert([
            ...
            'home_seo' => json_encode([
                'meta_title' => 'Showroomz',
                'meta_description' => 'Enjoy a seamless shopping experience for your home furniture.',
                'meta_keywords' => 'eCommerce, furniture, beds, bedrooms, showroom'
            ])
        ]);
